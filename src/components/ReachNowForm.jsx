...
export default function ReachNowForm() {
            ...
            <section id="enquiry" className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700">
                    <div className="flex flex-col md:flex-row-reverse">
                        ...
                        <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-700 dark:from-blue-700 dark:to-indigo-800 p-6 md:p-8 text-white relative overflow-hidden">
                            {/* Decorative elements */}
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold mb-6 text-gray-400">Be a part of our comprehensive training programs & start your journey towards becoming a Professional Developer today.</h3>
