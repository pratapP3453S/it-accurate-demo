          ...
          >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
              <div className="md:flex">
                {/* Left side - Info */}
                <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-purple-600 p-6 md:p-8 text-white flex flex-col justify-center relative overflow-hidden">
                ...
                <div className="md:w-1/2 p-6 md:p-8 relative">
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      type="submit"
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg"
                    >
